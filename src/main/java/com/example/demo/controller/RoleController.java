...
public class RoleController {
  ...
  @PutMapping("/{id}")
  public ApiRespone<RoleRespone> updateRole(
      @PathVariable String id, @RequestBody RoleRequest request) {
    return ApiRespone.<RoleRespone>builder().result(roleService.update(id, request)).build();
  }
}
