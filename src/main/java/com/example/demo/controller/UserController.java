...
public class UserController {
  ...
  public ApiRespone<UserRespone> getUser(@PathVariable String id) {
    ...
    return ApiRespone.<UserRespone>builder().result(userService.getUserById(id)).build();
  }
  ...
  public ApiRespone<List<UserRespone>> getAllUsers() {
    ...
    return ApiRespone.<List<UserRespone>>builder().result(userService.getAllUsers()).build();
  }
  ...
  @PutMapping("/{id}")
  public ApiRespone<UserRespone> updateUser(
      @PathVariable String id, @Valid @RequestBody UserRequest request) {
    return ApiRespone.<UserRespone>builder().result(userService.updateUser(id, request)).build();
  }

  @DeleteMapping("/{id}")
  public ApiRespone<String> deleteUser(@PathVariable String id) {
    userService.deleteUser(id);
    return ApiRespone.<String>builder().result("User has been deleted").build();
  }
}
